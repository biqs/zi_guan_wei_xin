<template>
	<div class="cash-wrapper">
		...
		<section class="list-box">
				   		...
				   		<div class="list-item" v-for="p in tempItems" @click="goTo(p.prdtCode,p.prdtType)" >
						  	...
						  	<div class="right">
						  	 		...
						  	 		<div class="type-1-rate" v-if='p.yieldValue'>
						  	 			<span class="title">七日年化收益</span>{{p.yieldValue | subLength(2)}}
						  	 			<span class="precent" v-if='p.yieldValue'>%</span>
						  	 		</div>
				   ...
				   <div v-if="type==3">
				   		...
				   		<div class="list-item" v-for="p in tempItems"  @click="goTo(p.prdtCode,p.prdtType)" >
				   			...
				   			<div class="right">
				   				 ...
				   				 <div class="type-3-date">净值日期：{{p.valueDate}}</div>
				   			</div>
				   		</div>
			...
			<div class="show-more" v-if='items.length==0'>
				 暂无数据！
			</div>

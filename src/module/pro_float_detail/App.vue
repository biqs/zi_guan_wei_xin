      ...
      <div class="value">
          ...
          <div class="sum">
             <!--  <div class="title">日涨跌幅</div>
              <div class="num" v-text='product.changeRate'></div> -->
    ...
    <div class="center-table">
            ...
            <div class="table">
                ...
                <div class="footer-date">
                  ...
                  <div v-text='subTime' class="text-center" v-if="valueType==1"></div>
...
<script>
  ...
  import {isEmpty,getTimeList} from 'src/common/js/unit';
  ...
  export default {
    ...
    watch:{
      product: function(val,oldVal){
        ...
        for (let i = val.valueList.length-1 ; i >=0 ; i --){
         ...
         this.dateList  =  this.valueType == 0 ? this.dateJZList :  getTimeList(); // this.dateSZist; 
    ...
    methods:{
      ...
      changeValueType(type){
        ...
        this.dateList  =  type == 0 ? this.dateJZList : getTimeList(); //getTimeList()实时时间坐标值
        this.initEcharts();
      },
      changeTimeType(type){
        this.timeType = type;
